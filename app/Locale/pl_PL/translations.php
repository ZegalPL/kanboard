...
return array(
    ...
    'Allow only one subtask in progress at the same time for a user' => 'Zezwalaj użytkownikowi na tylko jedno zadanie "w trakcie"',
    'Edit column "%s"' => 'Edytuj kolumnę "%s"',
    ...
    'Subtask timesheet' => 'Harmonogram pod-zadania',
    'There is nothing to show.' => 'Nie ma nic do wyświetlenia',
    'Time Tracking' => 'Śledzenie czasu',
    'You already have one subtask in progress' => 'Masz już rozpoczęte zadanie',
    'Which parts of the project do you want to duplicate?' => 'Które elementy projektu chcesz powielić?',
    ...
    'Disable login form' => 'Zablokuj formularz logowania',
